...
export class TaskBoardComponent implements OnInit {
  ...
  */
  ...
  taskMetaData:LabelData[] = [
    {label:"TO-DO",value:"0", type:'todo', data: this.toDo},
    {label:"IN PROGRESS",value:"1", type:'progress', data: this.inProgress},
    {label:"COMPLETED",    value:"2", type:'completed', data: this.completed},
    {label:"BLOCKED",value:"3", type:'blocked', data: this.blocked}
  ]
  ...
  ngOnInit() {
    ...
    if( !index ) index=0;
    this.updateTaskCanvas(index);
  }

  swapTasks(tabEvent:any) {
    this.updateTaskCanvas(tabEvent.value);
  }
  
  updateTaskCanvas(index){
